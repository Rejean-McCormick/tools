    ...
    def write_volume_json(self, filename: str, files: List[Path], title: str, nav_context: dict) -> Optional[dict]:
        ...
        try:
            ...
            with out_path.open("w", encoding="utf-8") as out:
                # CHANGED: ensure_ascii=True prevents encoding errors
                # CHANGED: indent=None reduces file size to prevent upload truncation
                json.dump(volume, out, indent=None, ensure_ascii=True)
